...
python DREAMER_main.py preprocessing ../../dataset/dreamer/DREAMER.mat eeg DREAMER_features_eeg.csv --Add_Target_Emotion anger --Add_Target_Emotion fear --Add_Target_Emotion calmness
...
python DREAMER_main.py preprocessing ../../dataset/dreamer/DREAMER.mat ecg DREAMER_features_ecg.csv --Add_Target_Emotion anger --Add_Target_Emotion fear --Add_Target_Emotion calmness
...
python DREAMER_main.py preprocessing ../../dataset/dreamer/DREAMER.mat both DREAMER_features_both.csv --Add_Target_Emotion anger --Add_Target_Emotion fear --Add_Target_Emotion calmness
